// Add to top of background.js and content.js
        ...
        if (chrome.runtime?.id) {
            try {
                chrome.runtime.sendMessage(message).catch(err => {
                    console.log('StepForge: Could not send message (extension might be reloaded)', err);
                });
            } catch (e) {
                console.log('StepForge: Extension context invalidated');
            }
        }
    }
    ...
    function handleEvent(e) {
        ...
        try {
            ...
            if (e.type === 'blur') {
                ...
                if (isSubmitClick) {
                    console.log('Reqnroll: Checking for uncommitted input before click on', target.tagName);
                    ...
                    if (activeElement &&
                        ...
                        console.log('Reqnroll: Active input found:', {
                            value: currentValue,
                        ...
                        if (currentValue && currentValue !== lastValue) {
                            ...
                            if (inputSelector) {
                                console.log('Reqnroll: Recording input value before click:', currentValue);
                                sendMessageSafe({
                    ...
                    allInputs.forEach(input => {
                        ...
                        if (currentValue && currentValue !== lastValue && input !== activeElement) {
                            ...
                            if (inputSelector) {
                                console.log('Reqnroll: Found uncommitted input field:', currentValue);
                                sendMessageSafe({
                                    command: 'recordAction',
                                    action: {
                                        type: 'type',
